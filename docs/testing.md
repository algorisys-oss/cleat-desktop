...
50 tests: 16 unit, 14 Docker integration, 17 Podman integration, 3 compose streaming.
...
| `lists_containers_with_mapped_fields` | Running ⊆ all; names have the leading `/` stripped; state enum deserialises (not `"unknown"`) |
